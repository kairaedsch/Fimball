...
public class PinballMachineTest
{
    ...
    public void getElementAt()
    {
        ...
        PinballMachine pinballMachine = new PinballMachine("test", "id", java.util.Optional.of(""), Collections.emptyList(), Mockito.mock(PinballMachineManager.class), true);
    ...
    public void addHighscore()
    {
        ...
        PinballMachine pinballMachine = new PinballMachine("test", "id", java.util.Optional.of(""), highscores, Mockito.mock(PinballMachineManager.class), true);
