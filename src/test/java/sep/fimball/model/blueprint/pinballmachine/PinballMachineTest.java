...
public class PinballMachineTest
{
    ...
    public void getElementAt()
    {
        ...
        PinballMachine pinballMachine = new PinballMachine("test", "id", "", Collections.emptyList(), Mockito.mock(PinballMachineManager.class), true);
    ...
    public void addHighscore()
    {
        ...
        PinballMachine pinballMachine = new PinballMachine("test", "id", "", highscores, Mockito.mock(PinballMachineManager.class), true);
